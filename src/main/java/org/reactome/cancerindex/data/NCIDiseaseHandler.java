...
public class NCIDiseaseHandler
{
    ...
    public void loadData(BufferedReader reader) throws IOException
    {
        ...
        while ((line = reader.readLine()) != null)
        {
            ...
            termToDisease.put(tokens[1], disease);
            termToSupTerms.put(tokens[1], supTerms);
        }
        ...
        {
            DiseaseData disease = termToDisease.get(term);
            codeToDiseaseData.put(disease.getNciDiseaseConceptCode(), disease);
     ...
     * @param code
     * @param needRecursive
     *            true for getting all contained diseases.
     * @return
     */
    public Set<DiseaseData> getSubDiseases(String code, boolean needRecursive)
    {
    ...
    {
        String rootCode = "C3262"; // Neoplasm. Cannot find a good root for
                                   // cancer only.
        // It seems that many cancers are not included in malignant neoplasm
        // (e.g. HCC)
    ...
    public Set<String> getSubDiseaseCodes(String code, boolean needRecursive)
    {
    ...
    private void getSubDiseases(DiseaseData disease, Set<DiseaseData> rtn)
    {
    ...
    public void generateDiseaseOnlyThesaurus() throws IOException
    {
        ...
        Set<DiseaseData> diseases = getSubDiseases("C7057", true);
        diseases.add(root);
